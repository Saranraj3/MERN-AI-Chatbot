...
function Login() {
    ...
    return (
        <div className='overflow-y-hidden min-h-screen bg-gray-900 flex items-center justify-center'>
            <div>
                <h1 className='xs:text-xl lg:text-2xl pt-[3rem] font-Noto font-extrabold cursor-pointer text-center text-white'>Welcome Back To You're Account </h1>
                <form onSubmit={Handlesumbit}>
                    ...
                    <div className='mt-3 flex justify-center'>
                        <button disabled={loading} type='submit' className='h-[2.5rem] w-[18rem] font-bold text-lg hover:opacity-80 rounded-sm bg-green-400'>{loading ? 'Loading...' : 'Submit'}</button>
                    </div>
                    <div className='mt-3 flex justify-center'>
                        <img className='cursor-pointer absolute size-[2.5rem]' src={googlelogo} alt="" />
                        <button type='submit' className='h-[2.5rem] w-[18rem] rounded-sm bg-white'></button>
                    </div>
