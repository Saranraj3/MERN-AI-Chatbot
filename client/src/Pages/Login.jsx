    ...
    return (
        <div>
            ...
            <form>
                ...
                <input className='cursor-pointer mt-[2rem] ml-[46rem] pl-2 w-[20rem] h-[3rem] rounded-md text-white  bg-gray-600' type="email" placeholder='Enter Your Email Address' />
                <input className='cursor-pointer mt-[1rem] ml-[46rem] pl-2 w-[20rem] h-[3rem] rounded-md text-white  bg-gray-600' type={(showPassword === false) ? 'password' : 'text'} placeholder='Password' />
