...
function Signup() {
    ...
    return (
        <div className='overflow-y-hidden min-h-screen bg-gray-900 flex items-center justify-center'>
            <div>
                <h1 className='xs:text-2xl lg:text-3xl  pt-[3rem] font-Noto font-extrabold cursor-pointer text-center text-white'>Register You're Account</h1>
                <form onSubmit={Handlesumbit}>
                    ...
                    <div className='mt-3 flex justify-center'>
                        <button disabled={loading} type='submit' className='h-[2.5rem] w-[18rem] text-lg font-bold hover:opacity-80 rounded-sm bg-green-400'>{loading ? 'Loading...' : 'Submit'}</button>
                    </div>
